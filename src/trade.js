...
Trade.prototype.checkOff = function checkOff() {
...
Trade.prototype.validateOffer = function validateOffer() {
    console.log("s");

    //katotaan käyttäjän invi ja sieltä itemin id:llä price ja jos suht sama ni ok
    /*
    const self = this
